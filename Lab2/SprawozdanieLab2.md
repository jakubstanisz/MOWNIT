...
Celem niniejszego zadania jest zastosowanie metody najmniejszych kwadratów (MNK) do predykcji roku wydania utworów muzycznych. Podstawą do rozwiązania problemu jest zbiór danych `YearPredictionMSD.txt`. Pierwsza kolumna zbioru reprezentuje rok wydania, natomiast pozostałe kolumny to zbiór 90 cech akustycznych (12 cech to średnia barwa, a pozostałe 78 dotyczy kowariancji barwy). Zbiór został podzielony na część treningową, obejmującą pierwsze 463 715 przykładów, oraz zbiór testowy, składający się z pozostałych 51 630 przykładów.
...
![image](graph.png)
<center> Rys. 1. histogram i wykres obrazujący wczytane dane. </center>
...
### 4. Wyznaczanie Wag i Warianty LSM
...
Wniosek: Współczynnik uwarunkowania wpływa na liczbę cyfr znaczących w reprezentacji wag. Skalowanie metodą *min-max* znacząco zmniejszyło wartość współczynnika uwarunkowania. W przypadku macierzy nieznormalizowanej tracone jest 9 cyfr znaczących, a dla znormalizowanej tylko 6, co dowodzi znacznej poprawy właściwości numerycznych i odporności modelu na błędy zaokrągleń.
...
### 8. Wnioski
1. Prosty model oparty na MNK osiągnął zadowalający błąd predykcji na poziomie około 6.8 roku.
2. Normalizacja danych jest kluczowa dla stabilności numerycznej, drastycznie poprawiła uwarunkowanie macierzy, zapobiegając utracie cyfr znaczących.
3. Klasyczne równanie normalne, SVD oraz regularyzacja Tichonowa dały identyczne wyniki predykcji, co potwierdza poprawność obliczeń.
4. Przetwarzanie blokowe pozwala na oszczędność pamięci operacyjnej bez spadku jakości. Model skutecznie wyuczył się najważniejszych cech i ustabilizował błąd już po przetworzeniu 300 tysięcy próbek.

### 9. Bibliografia
1. Materiały dydaktyczne do laboratorium: *Metoda Najmniejszych Kwadratów* (lab2.pdf)